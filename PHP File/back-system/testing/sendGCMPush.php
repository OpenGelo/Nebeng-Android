 ...
 * 
 */
function exec_push($message, $device_token, $value){
	global $curlHandle;
	global $sukses;

	//inisialisasi body request untuk Curl Request
	$post_fields = array(
	    'data'	=> array('message'	=>"Tes + $value"),	//kirim pesan tertentu
...
//=====Main====//
	...
	//init and test call the push
	set_gcm_push();
	for ($i=0; $i < 100; $i++) { 
		exec_push($message_accepted,$token,$i);
	}
	echo "Keberhasilan: ".$sukses/100."%";
//=====Main====//
