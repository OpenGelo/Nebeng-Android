...
$timeExpiredToString  = $time_expired->format('H:i:s');
    ...
    $query_join = mysql_query("SELECT user_id, nebeng_user.nama, nebeng_user.npm, asal, tujuan, sisa_kapasitas,waktu_berangkat, jam_berangkat, jam_kadaluarsa,keterangan
