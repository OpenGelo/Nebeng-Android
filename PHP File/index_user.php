...
*This website is still under construction. Nebeng and make nebeng features are not activated.
        ...
        <div class="wrapper">
          ...
          <div class="col-2">
            <form action="check_proses_nebeng_web.php" method="post">
               <h3 style="text-align:center;color:#000000;">Welcome</h3>
               <img src="images/User.png" width="25%" height="30%" style="float:left;display:inline-block;padding-top:15px;">
               <fieldset id = "id_user">
                  <br>
                  <?php
                    session_start();
                    ...
                    echo "<p>".$_SESSION['login_npm']."</p>";
                    echo "<p>".$_SESSION['login_role']."</p>";
                    echo "</div>";
                  ?>
          
               </fieldset>
               <button class="bknform beri" type="submit" name="beritebeng" value="nebeng"><span class="buttontext">Beri Tebengan!</span></button>
               <button class="bknform logout" type="submit" name="logout" value="logout"><span class="buttontext">Log Out</span></button>
             </form>
           </div>
           <br><br>           
           <h3 align="center" style="color:#000000;clear:both">Nebeng's Log:</h3>
           <div class = "container">
    	    <?php
