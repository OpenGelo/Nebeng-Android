...
public class MainActivity extends Activity {
    ...
    void cek() {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("username", SaveSharedPreference.getUserName(MainActivity.this).trim()));
            ...
            if (response.equalsIgnoreCase("User Found")) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(MainActivity.this, "Login Tidak berhasil, silahkan login ulang", Toast.LENGTH_SHORT).show();
                    }
                });
            }
